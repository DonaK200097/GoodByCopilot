...
> Ниже можно разместить изображения интерфейса из папки `assets/screenshots/`.  
> Если вы загрузите файлы в репозиторий под указанными именами, GitHub покажет их прямо в README.

| Главный экран | Настройки |
| --- | --- |
| ![Главный экран](assets/screenshots/main-window.png) | ![Настройки](assets/screenshots/settings-window.png) |
